...
— and `RUNBOOK.md:235-238` repeats the intent for phase 3. Nothing is
...
(`happenstance-runtime/src/lib.rs:37-40`, `RUNBOOK.md:242`) has nowhere
...
question in `RUNBOOK.md`'s decision ledger — the ledger names the
...
Not a single line in `.kb/decisions/`, `RUNBOOK.md`, or any crate's module
