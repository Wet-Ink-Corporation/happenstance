...
independently, as a byproduct of building [`standards/rust/`](../../standards/rust/README.md), by
...
`crates/**` or `xtask/**` in this pass broke citations in `standards/rust/` — three
...
says its constant is "the same twelve `standards/rust`'s own citation lint uses".
