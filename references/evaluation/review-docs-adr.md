...
| Every `.kb/decisions/NNNN` link and every RUNBOOK anchor | all | **All resolve.** `#phase-7--publish-01`, `#standing-constraints`, `#release-hazard`, `#decision-ledger` all match their headings. |
