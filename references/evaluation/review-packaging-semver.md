...
**Date:** 2026-08-05 · **Tree:** `main` @ `9fd2337` (dirty: modified docs, untracked `.idea/`, `.mcp.json`, `RUNBOOK.md`, `.kb/decisions/0006-*`)
...
| Docs | `README.md` (status table, quick start, design section), `CLAUDE.md` (repo map + 5 name mentions in the constraints), `CONTRIBUTING.md`, `RUNBOOK.md` (27 mentions) | rewrite |
...
(`RUNBOOK.md:223-225`) and calls it "Mechanical, and cheapest before the worked example is
...
(`RUNBOOK.md:61-75`) and not a checkbox in phase 7 (lines 435-450). I queried the registry
during this review:
...
(`RUNBOOK.md:443-446`) rather than deferring it.
