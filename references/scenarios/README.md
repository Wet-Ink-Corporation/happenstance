...
goes wrong. [`E2E-CASES.md`](../../spec/E2E-CASES.md) turns the breakages into test cases.
...
*Credit where it is due.* This is not a discovery. `references/evaluation/revised-runway.md`
...
*and yields `conflicting_position`* — which `references/evaluation/review-adapter-implementability.md`
