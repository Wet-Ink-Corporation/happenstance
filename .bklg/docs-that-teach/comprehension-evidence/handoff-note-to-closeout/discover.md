...
item: HS-S0171
stage: discover
created: 2026-08-17T06:47:26.720Z
updated: 2026-08-17T06:47:26.720Z
template_sig: 86ce4036
rendered_sig: 682a5a92
---

# Discover — The hand-off note naming one directly observed persona
...
| ------ | ------ | ----------- |
| The slice, as the story map states it | `comprehension-evidence/_storymap.md` | Write the named hand-off section stating one directly observed persona, the date, the tree walked and the scope sentence, in a form HS-P0025 can lift without re-deriving anything, so the blanket "none has been directly observed" qualification is replaced by an accurate one. |
| Project acceptance criteria this slice traces to | `comprehension-evidence/_storymap.md` | AC-008, AC-009 — the spec's AC-### must map onto these, not restate them |
...
| Dependency edges | `comprehension-evidence/_storymap.md` | `route-and-escalate`, `scope-the-claim`, `second-session-decision` |
...
Write the named hand-off section stating one directly observed persona, the date, the tree walked and the scope sentence, in a form HS-P0025 can lift without re-deriving anything, so the blanket "none has been directly observed" qualification is replaced by an accurate one.
...
behaviour, the AC-### enumeration mapping onto AC-008, AC-009, and the integration contract naming
the real mount point — none of which is decided here.

## The wrong implementation

A handoff that states no persona was directly observed, when the session observed one — the blanket qualification shipped unchanged.
