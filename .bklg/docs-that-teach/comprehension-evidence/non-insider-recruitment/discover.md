...
item: HS-S0164
stage: discover
created: 2026-08-17T06:38:34.059Z
updated: 2026-08-17T06:38:34.059Z
template_sig: 86ce4036
rendered_sig: f591fc60
---

# Discover — Recruit a reader who is verifiably outside, and record the declaration
...
| ------ | ------ | ----------- |
| The slice, as the story map states it | `comprehension-evidence/_storymap.md` | Apply the written criteria to a real candidate and record the reader's own declaration, platform, toolchain and assistive technology in the log — including the ineligible-but-used-anyway state, if it occurs, as a stated failure of the artefact rather than a redefinition of the bar. |
| Project acceptance criteria this slice traces to | `comprehension-evidence/_storymap.md` | AC-003 — the spec's AC-### must map onto these, not restate them |
...
| Dependency edges | `comprehension-evidence/_storymap.md` | `dt9-and-fixed-protocol`, `friction-log-skeleton` |
...
A logger who has read the ADRs or the evaluation corpus. The evidence implicates insider knowledge, not authorship, as what routes a reader around the rough spots.
