...
item: HS-S0166
stage: discover
created: 2026-08-17T06:41:24.876Z
updated: 2026-08-17T06:41:24.876Z
template_sig: 86ce4036
rendered_sig: 8fb0f2ca
---

# Discover — Exactly one disposition per stumble, readable at the stumble
...
| ------ | ------ | ----------- |
| The slice, as the story map states it | `comprehension-evidence/_storymap.md` | Give every severity-marked item exactly one disposition — fixed, deliberately accepted with its reason, or routed — readable at the stumble itself, with any later change recorded as a revision beside the original rather than overwriting it. |
...
Give every severity-marked item exactly one disposition — fixed, deliberately accepted with its reason, or routed — readable at the stumble itself, with any later change recorded as a revision beside the original rather than overwriting it.
...
A log filed with its stumbles summarised into a vibe rather than each one traceable to a fix, an acceptance, or a routing.
