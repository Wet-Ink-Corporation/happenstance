...
item: HS-S0168
stage: discover
created: 2026-08-17T06:43:50.816Z
updated: 2026-08-17T06:43:50.816Z
template_sig: 86ce4036
rendered_sig: d91fbc1b
---

# Discover — Land the small content fixes a "fixed" disposition asserts
...
| ------ | ------ | ----------- |
| The slice, as the story map states it | `comprehension-evidence/_storymap.md` | Land the small content fixes whose disposition is "fixed", composing from the existing primitive layer — doc-comment sections and intra-doc links, docs/README.md's routing-table shape, compiled examples — and prove each one through cargo xtask affected and cargo xtask ci --fast. |
| Project acceptance criteria this slice traces to | `comprehension-evidence/_storymap.md` | AC-006 — the spec's AC-### must map onto these, not restate them |
...
Land the small content fixes whose disposition is "fixed", composing from the existing primitive layer — doc-comment sections and intra-doc links, docs/README.md's routing-table shape, compiled examples — and prove each one through cargo xtask affected and cargo xtask ci --fast.
...
Fixes applied to the pages the author found easiest to change rather than the ones the log implicates.
