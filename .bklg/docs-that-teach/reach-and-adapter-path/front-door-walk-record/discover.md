...
item: HS-S0160
stage: discover
created: 2026-08-17T06:32:58.289Z
updated: 2026-08-17T06:32:58.289Z
template_sig: 86ce4036
rendered_sig: 787b3d80
---

# Discover — The observed front-door walk
...
| ------ | ------ | ----------- |
| The slice, as the story map states it | `reach-and-adapter-path/_storymap.md` | Someone who did not install the pointer starts from nothing but what cargo add happenstance shows and reaches the narrative material keyboard-only, leaving a dated record of what they opened, in order. |
| Project acceptance criteria this slice traces to | `reach-and-adapter-path/_storymap.md` | AC-004 — the spec's AC-### must map onto these, not restate them |
...
| Dependency edges | `reach-and-adapter-path/_storymap.md` | `front-door-pointer` |
...
Someone who did not install the pointer starts from nothing but what cargo add happenstance shows and reaches the narrative material keyboard-only, leaving a dated record of what they opened, in order.
...
A walk performed by an insider, who routes around the rough spots without noticing them.
