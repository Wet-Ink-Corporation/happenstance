...
item: HS-S0157
stage: discover
created: 2026-08-17T06:28:49.949Z
updated: 2026-08-17T06:28:49.949Z
template_sig: 86ce4036
rendered_sig: 2fb49e5f
---

# Discover — The observed error-site walk
...
| ------ | ------ | ----------- |
| The slice, as the story map states it | `reach-and-adapter-path/_storymap.md` | A person who did not write the rewrite reproduces the E0034 collision, reaches the reasoning account keyboard-only from the file and the message alone, and leaves a dated record naming each hop and their relationship to the work. |
| Project acceptance criteria this slice traces to | `reach-and-adapter-path/_storymap.md` | AC-009 — the spec's AC-### must map onto these, not restate them |
| Milestone / slice | `reach-and-adapter-path/_storymap.md` | `adapter-error-walk` — its slice-mates are delivered with it |
| Archetype | `reach-and-adapter-path/_storymap.md` | `capability` — a user-observable slice through every layer |
| Dependency edges | `reach-and-adapter-path/_storymap.md` | `adapter-reasoning-account`, `store-error-site-rewrite` |
...
A person who did not write the rewrite reproduces the E0034 collision, reaches the reasoning account keyboard-only from the file and the message alone, and leaves a dated record naming each hop and their relationship to the work.
...
behaviour, the AC-### enumeration mapping onto AC-009, and the integration contract naming
the real mount point — none of which is decided here.

## The wrong implementation

A walk asserted rather than observed, by someone who already knew where the explanation was.
