...
item: HS-S0148
stage: discover
created: 2026-08-17T06:16:48.057Z
updated: 2026-08-17T06:16:48.057Z
template_sig: 86ce4036
rendered_sig: dcd3e2c5
---

# Discover — DT-8 resolved as a rule a reviewer can apply without the author
...
| ------ | ------ | ----------- |
| The slice, as the story map states it | `page-need-discipline/_storymap.md` | Resolve DT-8 and write it as a checkable rule — if the collapsed section were deleted, would the page still teach the constraint correctly? — covering the declaration itself, which may never be occluded. |
| Project acceptance criteria this slice traces to | `page-need-discipline/_storymap.md` | AC-005 — the spec's AC-### must map onto these, not restate them |
...
Resolve DT-8 and write it as a checkable rule — if the collapsed section were deleted, would the page still teach the constraint correctly? — covering the declaration itself, which may never be occluded.
...
Reviewer judgement in place of a stated rule — right at the edges and drifting everywhere else, which is exactly how an invariant stated twice drifted here once already.
