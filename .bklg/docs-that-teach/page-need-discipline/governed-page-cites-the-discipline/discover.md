...
item: HS-S0152
stage: discover
created: 2026-08-17T06:23:02.330Z
updated: 2026-08-17T06:23:02.330Z
template_sig: 86ce4036
rendered_sig: 787c58dd
---

# Discover — A governed page names the discipline as the reason it is shaped as it is
...
| ------ | ------ | ----------- |
| The slice, as the story map states it | `page-need-discipline/_storymap.md` | At least one page in HS-P0020's pinned tree names the discipline as the reason it is shaped as it is, as a link the checker's own pin keeps resolving, and the discipline links back to the material it governs. |
| Project acceptance criteria this slice traces to | `page-need-discipline/_storymap.md` | AC-011 — the spec's AC-### must map onto these, not restate them |
| Milestone / slice | `page-need-discipline/_storymap.md` | `binding-beyond-this-project` — its slice-mates are delivered with it |
| Archetype | `page-need-discipline/_storymap.md` | `capability` — a user-observable slice through every layer |
| Dependency edges | `page-need-discipline/_storymap.md` | `router-precedence-and-announcement`, `page-need-checker-mounted-in-the-gate` |
...
At least one page in HS-P0020's pinned tree names the discipline as the reason it is shaped as it is, as a link the checker's own pin keeps resolving, and the discipline links back to the material it governs.
...
behaviour, the AC-### enumeration mapping onto AC-011, and the integration contract naming
the real mount point — none of which is decided here.

## The wrong implementation

A discipline on disk that no page cites, so nothing demonstrates it is reachable or that it governs anything.
