...
item: HS-S0153
stage: discover
created: 2026-08-17T06:24:16.708Z
updated: 2026-08-17T06:24:16.708Z
template_sig: 86ce4036
rendered_sig: 807662c7
---

# Discover — The playbook atom staged under .kb/_intake/, never hand-authored into .kb/
...
| ------ | ------ | ----------- |
| The slice, as the story map states it | `page-need-discipline/_storymap.md` | Stage a kind: playbook, authority_tier: guideline atom under .kb/_intake/ carrying the method, the rejected alternatives and the conditions under which the discipline stops holding — with a field-by-field frontmatter check in the ledger, because redkiln validate --kb skips _-prefixed directories by design. |
| Project acceptance criteria this slice traces to | `page-need-discipline/_storymap.md` | AC-012 — the spec's AC-### must map onto these, not restate them |
...
| Dependency edges | `page-need-discipline/_storymap.md` | `fold-line-rule`, `reviewer-and-citation-procedures`, `declaration-check-seen-to-fail` |
...
A hand-authored `.kb/` atom outside the ingest path — the practice reverted at `0269720` for producing the directory layout of the process without the process.
