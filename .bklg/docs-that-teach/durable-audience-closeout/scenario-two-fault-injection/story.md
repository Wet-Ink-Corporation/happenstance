...
uid: 357ac6
type: story
slug: scenario-two-fault-injection
title: "Re-observe scenario 2 in both halves: fail by name, then recover"
parent: HS-P0025
...
---
# Re-observe scenario 2 in both halves: fail by name, then recover
