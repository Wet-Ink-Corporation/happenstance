...
item: HS-S0177
stage: discover
created: 2026-08-17T06:55:02.894Z
updated: 2026-08-17T06:55:02.894Z
template_sig: 86ce4036
rendered_sig: 629f0a80
---

# Discover — Stage the persona and journey documents for the closeout wave
...
| ------ | ------ | ----------- |
| The slice, as the story map states it | `durable-audience-closeout/_storymap.md` | Author the staged persona and journey documents under `.kb/_intake/` — four slots per persona, the evaluator decision transcribed, all three evidence qualifications adjacent to the claims they qualify, and the blanket "none has been directly observed" replaced by naming the persona HS-P0024's session walked. |
| Project acceptance criteria this slice traces to | `durable-audience-closeout/_storymap.md` | AC-003, AC-006, AC-007 — the spec's AC-### must map onto these, not restate them |
...
| Dependency edges | `durable-audience-closeout/_storymap.md` | `reconciliation-ledger`, `charter-open-question-disposition` |
...
Author the staged persona and journey documents under `.kb/_intake/` — four slots per persona, the evaluator decision transcribed, all three evidence qualifications adjacent to the claims they qualify, and the blanket "none has been directly observed" replaced by naming the persona HS-P0024's session walked.
...
behaviour, the AC-### enumeration mapping onto AC-003, AC-006, AC-007, and the integration contract naming
the real mount point — none of which is decided here.

## The wrong implementation

Personas authored fresh here — the named failure mode, two initiatives inventing the same audience.
