...
uid: 3d0aee
type: story
slug: post-merge-clause-completeness
title: Re-run spec-trace post-merge and state clause-id completeness
parent: HS-P0025
...
---
# Re-run spec-trace post-merge and state clause-id completeness
