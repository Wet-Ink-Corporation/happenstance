...
item: HS-S0175
stage: discover
created: 2026-08-17T06:52:24.165Z
updated: 2026-08-17T06:52:24.165Z
template_sig: 86ce4036
rendered_sig: f556d0b4
---

# Discover — Dispose of every charter open question, evaluator included
...
| ------ | ------ | ----------- |
| The slice, as the story map states it | `durable-audience-closeout/_storymap.md` | Dispose of every question in the charter's `## Open questions for the planning team` — answered on the record, or staged as an `open_question` atom for this project's single ingest wave — and settle the evaluator question once, with its reasoning, marking the charter's line answered. |
| Project acceptance criteria this slice traces to | `durable-audience-closeout/_storymap.md` | AC-017, AC-003 — the spec's AC-### must map onto these, not restate them |
...
| Dependency edges | `durable-audience-closeout/_storymap.md` | `reconciliation-ledger` |
...
Dispose of every question in the charter's `## Open questions for the planning team` — answered on the record, or staged as an `open_question` atom for this project's single ingest wave — and settle the evaluator question once, with its reasoning, marking the charter's line answered.
...
behaviour, the AC-### enumeration mapping onto AC-017, AC-003, and the integration contract naming
the real mount point — none of which is decided here.

## The wrong implementation

Open questions left open, or quietly dropped, rather than answered on the record or converted into an `open_question` atom.
