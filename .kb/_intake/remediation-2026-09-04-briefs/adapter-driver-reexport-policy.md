...
```
— `crates/happenstance-sqlite/src/event_store.rs:430`; and
...
`crates/happenstance-sqlite/src/event_store.rs:471` and `pub fn open_in_memory()` at
...
`rusqlite::Connection` is in `new`'s parameter list (`event_store.rs:430`) and
