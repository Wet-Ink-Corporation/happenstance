...
admits (`xtask/src/spec_trace.rs:1750-1755`):
...
"noise indistinguishable from a real typo" (`xtask/src/spec_trace.rs:1746-1748`). The suite was
...
(`xtask/src/spec_trace.rs:2362-2369`) now asserts `has_suite("PS-1")` and `has_suite("PS-37")`
