...
#
#   bash experiments/position-visibility/run.sh              # everything
#   bash experiments/position-visibility/run.sh inversion    # part 1 only
#   bash experiments/position-visibility/run.sh throughput   # part 2 only
#   bash experiments/position-visibility/run.sh staleness    # arm C only
#   bash experiments/position-visibility/run.sh keep         # leave it up
set -euo pipefail
