...
//! by the trait definition. Two of eventum's targets disagree about that:
//!
...
/// [`eventum-testkit`](https://docs.rs/eventum-testkit) checks every one of
...
///
/// ```
/// use eventum_core::{EventStore, Query, ReadOptions, collect};
///
