...
**Evidence.** `crates/happenstance-cloudflare/src/lib.rs:184 (The host build is a convenience rather than evidence)` ·
...
`xtask/src/main.rs:799 (feature is not target-scoped)`
...
**Evidence.** `crates/happenstance-cloudflare/src/lib.rs:204 (Left un-gated it is dead code on wasm)` ·
`crates/happenstance-cloudflare/src/lib.rs:236 (mod not_send_probe)` ·
