...
`crates/happenstance-sqlite/src/event_store.rs:1338 (Nothing is executed here on purpose)` ·
...
**Evidence.** `crates/happenstance-sqlite/src/event_store.rs:227 (but **not**)` ·
`crates/happenstance-sqlite/src/event_store.rs:229 (The mutex is what buys)` ·
...
**Evidence.** `crates/happenstance-sqlite/src/event_store.rs:1510 (boundary would)` ·
`crates/happenstance-sqlite/src/event_store.rs:2014 (runtime.spawn_blocking(move ||)` ·
[ES-2](../../spec/SPECIFICATION.md) ·
[adapter-shapes §2.1](../../references/adapter-shapes.md)
