...
`crates/happenstance-sqlite/src/event_store.rs:1289 (Nothing is executed here on purpose)` ·
...
`crates/happenstance-sqlite/src/event_store.rs:1927 (Handle::try_current())` ·
`crates/happenstance-sqlite/src/event_store.rs:1178 (no tokio runtime is available)` ·
...
**Evidence.** `crates/happenstance-sqlite/src/event_store.rs:218 (but **not**)` ·
`crates/happenstance-sqlite/src/event_store.rs:220 (is what makes)` ·
...
**Evidence.** `crates/happenstance-sqlite/src/event_store.rs:1461 (boundary would)` ·
`crates/happenstance-sqlite/src/event_store.rs:1932 (runtime.spawn_blocking(move ||)` ·
[ES-2](../../spec/SPECIFICATION.md) ·
[adapter-shapes §2.1](../../references/adapter-shapes.md)
