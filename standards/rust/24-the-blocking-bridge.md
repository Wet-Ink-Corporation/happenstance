...
`crates/happenstance-sqlite/src/event_store.rs:1209 (Nothing is executed here on purpose)` ·
...
`crates/happenstance-sqlite/src/event_store.rs:1847 (Handle::try_current())` ·
`crates/happenstance-sqlite/src/event_store.rs:1130 (no tokio runtime is available)` ·
...
**Evidence.** `crates/happenstance-sqlite/src/event_store.rs:1381 (boundary would)` ·
`crates/happenstance-sqlite/src/event_store.rs:1852 (runtime.spawn_blocking(move ||)` ·
[ES-2](../../spec/SPECIFICATION.md) ·
[adapter-shapes §2.1](../../references/adapter-shapes.md)
