...
`crates/happenstance-core/Cargo.toml:78 (workspace = true)` ·
...
`xtask/src/main.rs:502 (no default features)` ·
`xtask/src/main.rs:531 (documentation (default features))` ·
...
**Evidence.** `crates/happenstance-core/src/lib.rs:96 (feature(doc_cfg))` ·
