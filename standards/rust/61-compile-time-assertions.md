...
**Evidence.** `crates/happenstance-cloudflare/src/lib.rs:520 (struct Probe)` ·
`crates/happenstance-cloudflare/src/lib.rs:576 (fn the_probe_is_not_vacuous)` ·
`crates/happenstance-cloudflare/src/lib.rs:531 (is the entire mechanism)` ·
