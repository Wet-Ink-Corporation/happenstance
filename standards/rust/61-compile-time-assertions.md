...
**Evidence.** `crates/happenstance-cloudflare/src/lib.rs:355 (struct Probe)` ·
`crates/happenstance-cloudflare/src/lib.rs:411 (fn the_probe_is_not_vacuous)` ·
`crates/happenstance-cloudflare/src/lib.rs:366 (is the entire mechanism)` ·
