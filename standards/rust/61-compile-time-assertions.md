...
**Evidence.** `crates/happenstance-cloudflare/src/lib.rs:613 (struct Probe)` ·
`crates/happenstance-cloudflare/src/lib.rs:669 (pub(crate) fn the_probe_is_not_vacuous)` ·
`crates/happenstance-cloudflare/src/lib.rs:624 (is the entire mechanism)` ·
...
**Evidence.** `crates/happenstance-ladybug/tests/port_shape.rs:126 (const _: () = {)` ·
`crates/happenstance-ladybug/tests/port_shape.rs:123 (Instantiating a generic function)` ·
