...
**Evidence.** `crates/happenstance-cloudflare/src/lib.rs:383 (struct Probe)` ·
`crates/happenstance-cloudflare/src/lib.rs:439 (fn the_probe_is_not_vacuous)` ·
`crates/happenstance-cloudflare/src/lib.rs:394 (is the entire mechanism)` ·
