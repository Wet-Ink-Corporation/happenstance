...
**Evidence.** `crates/happenstance-sqlite/src/event_store.rs:1143 (needs no pin)` ·
...
**Evidence.** `crates/happenstance-sqlite/src/event_store.rs:1489 (std::mem::replace(&mut this.state)` ·
