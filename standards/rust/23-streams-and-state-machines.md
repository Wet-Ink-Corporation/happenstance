...
**Evidence.** `crates/happenstance-sqlite/src/event_store.rs:1166 (needs no pin)` ·
...
**Evidence.** `crates/happenstance-sqlite/src/event_store.rs:1481 (std::mem::replace(&mut this.state)` ·
