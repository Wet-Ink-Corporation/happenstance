...
**Evidence.** `crates/happenstance-sqlite/src/event_store.rs:1290 (needs no pin)` ·
...
**Evidence.** `crates/happenstance-sqlite/src/event_store.rs:1619 (std::mem::replace(&mut this.state)` ·
