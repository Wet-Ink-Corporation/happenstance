...
**Evidence.** `crates/happenstance-sqlite/src/event_store.rs:1385 (needs no pin)` ·
...
**Evidence.** `crates/happenstance-sqlite/src/event_store.rs:1821 (std::mem::replace(&mut this.state)` ·
