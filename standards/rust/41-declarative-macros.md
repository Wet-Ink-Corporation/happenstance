...
**Evidence.** `crates/happenstance-testkit/src/lib.rs:370 (qualified by the caller)` ·
...
**Evidence.** `crates/happenstance-testkit/src/lib.rs:346 (Listed first)`
...
`crates/happenstance-testkit/src/lib.rs:385 (mod_name = dcb_conformance)` ·
...
**Evidence.** `crates/happenstance-testkit/src/lib.rs:366 (async fn __conformance_fixture)` ·
...
**Evidence.** `crates/happenstance-testkit/src/contract.rs:586 (a rule's outcome must be reported)` ·
