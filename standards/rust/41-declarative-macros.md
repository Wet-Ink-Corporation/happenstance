...
**Evidence.** `crates/happenstance-testkit/src/lib.rs:546 (qualified by the caller)` ·
...
**Evidence.** `crates/happenstance-testkit/src/lib.rs:522 (Listed first)`
...
`crates/happenstance-testkit/src/lib.rs:561 (mod_name = dcb_conformance)` ·
...
**Evidence.** `crates/happenstance-testkit/src/lib.rs:542 (async fn __conformance_fixture)` ·
...
**Evidence.** `crates/happenstance-testkit/src/contract.rs:1114 (a rule's outcome must be reported)` ·
