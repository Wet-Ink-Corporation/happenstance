...
**Evidence.** `crates/happenstance-testkit/src/lib.rs:664 (for_each_event_store_rule!($emit))` ·
...
**Evidence.** `crates/happenstance-testkit/src/lib.rs:614 (macro_rules! event_store_conformance)`
...
`crates/happenstance-testkit/src/lib.rs:676 (mod_name = dcb_conformance,)` ·
...
**Evidence.** `crates/happenstance-testkit/src/lib.rs:635 (__conformance_fixture() -> impl $crate::__private::Fixture)` ·
...
**Evidence.** `crates/happenstance-testkit/src/contract.rs:1135 (a rule's outcome must be reported)` ·
