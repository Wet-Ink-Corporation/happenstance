...
**Evidence.** `crates/happenstance-testkit/src/lib.rs:384 (qualified by the caller)` ·
...
`crates/happenstance-testkit/src/registry.rs:413 (for_each_event_store_rule!(crate::__emit_rule_names))`
...
**Evidence.** `crates/happenstance-testkit/src/lib.rs:360 (Listed first)`
...
`crates/happenstance-testkit/src/lib.rs:399 (mod_name = dcb_conformance)` ·
...
**Evidence.** `crates/happenstance-testkit/src/lib.rs:380 (async fn __conformance_fixture)` ·
...
**Evidence.** `crates/happenstance-testkit/src/contract.rs:852 (a rule's outcome must be reported)` ·
