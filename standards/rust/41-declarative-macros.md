...
**Evidence.** `crates/happenstance-testkit/src/lib.rs:637 (qualified by the caller)` ·
...
**Evidence.** `crates/happenstance-testkit/src/lib.rs:613 (Listed first)`
...
`crates/happenstance-testkit/src/lib.rs:652 (mod_name = dcb_conformance)` ·
...
**Evidence.** `crates/happenstance-testkit/src/lib.rs:633 (async fn __conformance_fixture)` ·
...
**Evidence.** `crates/happenstance-testkit/src/contract.rs:1121 (a rule's outcome must be reported)` ·
