...
**Evidence.** `crates/happenstance-core/src/lib.rs:98 (extern crate alloc)` ·
...
**Evidence.** `crates/happenstance-core/Cargo.toml:73 (package.metadata.docs.rs)` ·
`crates/happenstance-core/src/lib.rs:96 (feature(doc_cfg))` ·
