...
`spec/SPECIFICATION.md:376 (Cargo features are additive)` ·
...
`xtask/src/main.rs:759 (names serde/alloc and base64/alloc)` ·
...
`xtask/src/main.rs:1047 (is a cfg nobody sets except docs.rs)` ·
