...
**Evidence.** `crates/happenstance-core/src/error.rs:188 (lifted out of the adapter's error type)` · `crates/happenstance-core/src/error.rs:253 (is_condition_violated)` · `crates/happenstance-core/src/error.rs:261 (pub fn map_store<F, T>)` · `crates/happenstance-sqlite/src/event_store.rs:887 (Append-condition violations are)` ·
...
**Evidence.** `crates/happenstance-sqlite/src/event_store.rs:900 (Carried as a unit variant rather than wrapping)` ·
`crates/happenstance-sqlite/src/event_store.rs:902 (it is neither)` ·
