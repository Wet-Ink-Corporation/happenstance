...
`crates/happenstance-core/src/store.rs:156 (type Error: core::error::Error + 'static)` · `crates/happenstance-core/src/projection.rs:428 (type Error: core::error::Error + 'static)` ·
[ADR-0009](../../.kb/decisions/0009-error-send-sync.md)
