...
`crates/happenstance-sqlite/src/event_store.rs:186 (flavour captures)` ·
...
**Evidence.** `crates/happenstance-sqlite/src/event_store.rs:192 (is not for sharing the store; it is so that a)` ·
`crates/happenstance-sqlite/src/event_store.rs:1276 (is what makes the whole)` ·
[ES-3](../../spec/SPECIFICATION.md) ·
[std::marker::Send](https://doc.rust-lang.org/std/marker/trait.Send.html) *(checked 2026-08-09, rustc 1.97.1)*
