...
**Evidence.** `crates/happenstance-core/src/store.rs:407 (error_projections_are_one_type)` ·
...
**Evidence.** `crates/happenstance-core/src/store.rs:109 (async fn count_all<S: EventStore>)` ·
