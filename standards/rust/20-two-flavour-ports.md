...
`crates/happenstance-ladybug/tests/port_shape.rs:49 (pub(crate) async fn advance<S: ProjectionStore>)` ·
...
`crates/happenstance-ladybug/tests/port_shape.rs:34 (makes every method call ambiguous)` ·
...
**Evidence.** `crates/happenstance-neon/src/event_store.rs:1006 (Pin<Box<dyn Future)` ·
