...
**Evidence.** `crates/happenstance-core/src/store.rs:295 (async fn head)` ·
...
`crates/happenstance-core/src/store.rs:295 (async fn head)` ·
...
`crates/happenstance-core/src/store.rs:170 (impl Stream<Item =)` ·
