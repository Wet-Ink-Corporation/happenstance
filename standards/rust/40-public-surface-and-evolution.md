...
**Evidence.** `crates/happenstance-testkit/src/contract.rs:1009 (pub const fn declined)` ·
`crates/happenstance-testkit/src/contract.rs:1002 (Where it does *not* fire)` ·
