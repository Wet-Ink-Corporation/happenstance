...
| 2 | **Adapter skeletons — three shapes, no behaviour** (3 d) | 1 | `docs/adapter-shapes.md`: a table of the **compiler errors** each rejected signature produced, for rusqlite, Durable Object `SqlStorage` and Ladybug. The evidence base for five later ADRs. |
