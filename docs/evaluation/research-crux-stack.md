...
- In-repo: `research-crux-integration.md`, `research-crux-composition.md`, `docs/architecture/SPECIFICATION.md` (CF-32, WF-1..12, SY-20), `docs/evaluation/review-blind-spots.md`
