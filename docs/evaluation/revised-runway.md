...
This replaces `docs/RUNBOOK.md`. It is not an edit of it — the ordering changed,
...
| Is `happenstance-runtime` the right name and seam | 0 | **decided** — executed in phase 0 | [0006](../../.kb/decision/0006-bare-name-to-the-typed-layer.md) |
...
- [ ] Write the capability table into `docs/adapter-shapes.md`: for each
...
**Proof artefact.** `docs/adapter-shapes.md`: five columns, one per skeleton,
...
- [ ] `docs/adapter-shapes.md` records at least one rejection — a signature with
...
**Decisions — ADR-0015.** Phase 2's `docs/adapter-shapes.md` is the evidence.
