...
[`docs/rust/`](../rust/README.md), not by a review commissioned to find them, and
...
**A working implementation now exists to port.** `docs/rust/`'s citations carry a
...
`docs/adr/0008`, `docs/adr/0009` and `docs/RUNBOOK.md`.
...
## 7. Open judgment calls inside `docs/rust/`
