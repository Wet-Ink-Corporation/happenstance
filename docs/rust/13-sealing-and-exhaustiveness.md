...
[SPECIFICATION VT-30](../architecture/SPECIFICATION.md) ·
...
[SPECIFICATION VT-26](../architecture/SPECIFICATION.md)
...
[SPECIFICATION VT-4](../architecture/SPECIFICATION.md)
...
**Evidence.** `crates/happenstance-testkit/src/contract.rs:469 (Deliberately exhaustive)` ·
`crates/happenstance-core/src/limits.rs:53 (non_exhaustive)` ·
[SPECIFICATION VT-25](../architecture/SPECIFICATION.md) ·
