...
[SPECIFICATION CF-6](../architecture/SPECIFICATION.md) ·
[SPECIFICATION CF-33](../architecture/SPECIFICATION.md)
...
[SPECIFICATION CF-29](../architecture/SPECIFICATION.md)
...
`xtask/src/package.rs:172 (fn reconcile)` · `xtask/src/package.rs:36 (The derivation is the fact)`
