...
[CF-15](../architecture/SPECIFICATION.md)'s sentence and not this atom's. Steps
...
[SPECIFICATION CF-16](../architecture/SPECIFICATION.md) ·
[SPECIFICATION CF-18](../architecture/SPECIFICATION.md) ·
[SPECIFICATION CF-40](../architecture/SPECIFICATION.md)
...
`docs/adapter-shapes.md:302 (A skeleton falsifies a signature)` ·
[SPECIFICATION CF-1](../architecture/SPECIFICATION.md) ·
