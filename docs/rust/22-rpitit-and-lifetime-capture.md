...
[SPECIFICATION CF-20](../architecture/SPECIFICATION.md) *(why `Fixture` is
...
[SPECIFICATION ES-2](../architecture/SPECIFICATION.md) *(the `read` case,
...
[SPECIFICATION ES-13](../architecture/SPECIFICATION.md) *(`[FROZEN]`: `read`
...
[SPECIFICATION PS-5](../architecture/SPECIFICATION.md) *(provisional: an owned
