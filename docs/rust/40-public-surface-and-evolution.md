...
[research §12](../evaluation/research-rust-api-guidelines.md) *(dated evidence)* ·
...
[adapter-shapes §2.2](../adapter-shapes.md) *(the `E0119` row)* ·
[ADR-0008](../adr/0008-one-derivation-for-both-ports.md)
...
[SPECIFICATION VT-4](../architecture/SPECIFICATION.md) *(the same attribute, on
...
[SPECIFICATION CF-18](../architecture/SPECIFICATION.md) *(why a declined
