...
> **Load when:** adding or editing a rule in `docs/rust/` · reaching for a
> `compile_fail` fence to prove something · about to cite `docs/evaluation/*` ·
...
[SPECIFICATION CF-1](../architecture/SPECIFICATION.md#61-the-suites-own-proof-obligation) ·
[ADR-0010](../adr/0010-the-suite-must-prove-itself.md)
...
`docs/architecture/SPECIFICATION.md:5607 (silently ignores)` ·
...
## RS-01-3. Cite the tree, not the audit: `docs/evaluation/*` is dated evidence, never a rule.
...
> `CLAUDE.md`/`CONTRIBUTING` summary > `docs/evaluation/*`, and inside an atom
...
`docs/evaluation/research-rust-api-guidelines.md:677 (Confirmed defect)` ·
[SPECIFICATION VT-13](../architecture/SPECIFICATION.md#vt-13--next-signals-overflow-and-the-inclusiveexclusive-asymmetry-is-deliberate) ·
[SPECIFICATION §1.1](../architecture/SPECIFICATION.md#11-what-this-document-is)
