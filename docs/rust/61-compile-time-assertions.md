...
[SPECIFICATION ES-2](../architecture/SPECIFICATION.md) ·
...
**Evidence.** `crates/happenstance-postgres/src/projection_store.rs:146 (proves nothing)` ·
`crates/happenstance-postgres/src/projection_store.rs:154 (universally-quantified lifetime parameter)` ·
`crates/happenstance-postgres/src/projection_store.rs:170 (fn the_batch_does_not_borrow_the_store)` ·
[SPECIFICATION PS-5](../architecture/SPECIFICATION.md)
...
**Evidence.** `crates/happenstance-cloudflare/src/lib.rs:160 (struct Probe)` ·
`crates/happenstance-cloudflare/src/lib.rs:211 (fn the_probe_is_not_vacuous)` ·
`crates/happenstance-cloudflare/src/lib.rs:171 (is the entire mechanism)` ·
`crates/happenstance-testkit/tests/local_conformance.rs:426 (is the entire mechanism)` ·
[SPECIFICATION ES-6](../architecture/SPECIFICATION.md)
...
**Evidence.** `crates/happenstance-ladybug/tests/port_shape.rs:75 (const _: () = {)` ·
`crates/happenstance-ladybug/tests/port_shape.rs:72 (Instantiating a generic function)` ·
