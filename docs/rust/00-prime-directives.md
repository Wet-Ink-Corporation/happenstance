...
[`SPECIFICATION.md`](../architecture/SPECIFICATION.md) cited under the rule: the
...
[SPECIFICATION ES-42](../architecture/SPECIFICATION.md#es-42--reads-return-type-carries-no-unpin-bound)
...
[SPECIFICATION ES-1](../architecture/SPECIFICATION.md#es-1--one-definition-two-flavours-and-generic-code-binds-the-weaker-one) ·
...
[SPECIFICATION ES-2](../architecture/SPECIFICATION.md#es-2--read-returns-the-stream-at-the-top-level-and-is-not-async) ·
[ADR-0001](../adr/0001-async-port-flavours.md) ·
...
[ADR-0029](../adr/0029-msrv-raised-to-1-97-1.md) ·
