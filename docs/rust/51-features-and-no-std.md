...
`docs/architecture/SPECIFICATION.md:355 (Cargo features are additive)` ·
...
[ADR-0016](../adr/0016-the-wire-format.md)
...
**Evidence.** `crates/happenstance-core/src/lib.rs:87 (extern crate alloc)` ·
