...
[SPECIFICATION ES-1](../architecture/SPECIFICATION.md) *(derived, not
hand-written)* · [SPECIFICATION ES-5](../architecture/SPECIFICATION.md) *(the
...
[SPECIFICATION ES-1](../architecture/SPECIFICATION.md) *(one name per module)* ·
[ADR-0001](../adr/0001-async-port-flavours.md)
...
[SPECIFICATION ES-7](../architecture/SPECIFICATION.md) *(the blanket impl a
...
[SPECIFICATION ES-42](../architecture/SPECIFICATION.md) *(the hand-written
