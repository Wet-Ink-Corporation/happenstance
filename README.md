...
> and a 114-rule conformance suite across four families are real and tested, and
...
| [`happenstance-testkit`](crates/happenstance-testkit) | Conformance suite adapters must pass | ✅ on crates.io at `0.2.0-alpha.1` — 114 rules across four families |
...
There are 114 rules in four families. The **event-store** family (91) covers
