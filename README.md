...
> and a 113-rule conformance suite across four families are real and tested, and
...
| [`happenstance-testkit`](crates/happenstance-testkit) | Conformance suite adapters must pass | ✅ on crates.io at `0.2.0-alpha.1` — 113 rules across four families |
...
There are 113 rules in four families. The **event-store** family (90) covers
